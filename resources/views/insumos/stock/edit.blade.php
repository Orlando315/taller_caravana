...
@section('brand')
  <a class="navbar-brand" href="{{ route('insumos.show', ['insumo' => $stock->insumo_id]) }}"> Stock </a>
@endsection
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card">
          <div class="card-body">
            <form action="{{ route('insumos.stock.update', ['stock' => $stock->id]) }}" method="POST">
              @csrf
              @method('PATCH')
              ...
              <div class="form-group text-right">
                <a class="btn btn-default" href="{{ route('insumos.show', ['insumo' => $stock->insumo_id]) }}"><i class="fa fa-reply"></i> Atras</a>
