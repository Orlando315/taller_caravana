        ...
        <div class="card-body">
          <form action="{{ route('perfil.update') }}" method="POST">
            ...
            <div class="form-group">
              ...
              <input id="apellidos" class="form-control{{ $errors->has('apellidos') ? ' is-invalid' : '' }}" type="text" name="apellidos" maxlength="50" value="{{ old('apellidos') ?? Auth::user()->apellidos }}" placeholder="Apellidos">
            </div>
        ...
        <div class="modal-body">
          <div class="row justify-content-center">
            <form class="col-md-8" action="{{ route('perfil.password') }}" method="POST">
              ...
              <div class="form-group">
                <label class="control-label" for="password">Actual: *</label>
                <input id="password_confirmation" class="form-control" type="password" pattern=".{6,}" name="actual" required>
              ...
              <div class=" form-group">
                <label class="control-label" for="confirmar">Confirmar contraseña: *</label>
                <input id="confirmar" class="form-control" type="password" pattern=".{6,}" name="password_confirmation" required>
                <small class="form-text text-muted">Debe contener al menos 6 caracteres.</small>
              </div>
