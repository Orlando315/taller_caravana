            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input id="factura" class="form-control{{ $errors->has('factura') ? ' is-invalid' : '' }}" type="text" name="factura" pattern="[0-9]+" maxlength="50" value="{{ old('factura') }}" placeholder="# Factura">
                </div>                  
              </div>
              <div class="col-md-3">
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input id="minimo" class="form-control{{ $errors->has('minimo') ? ' is-invalid' : '' }}" type="number" name="minimo" min="1" max="9999999999" value="{{ old('minimo') }}" placeholder="Stock mínimo">
                </div>                  
              </div>
              <div class="col-md-9">
                <div class="form-group">
                  <label class="control-label" for="decripcion">Descripción:</label>
                  <textarea id="decripcion" class="form-control{{ $errors->has('descripcion') ? ' is-invalid' : '' }}" type="text" name="descripcion">{{ old('descripcion') }}</textarea>
                </div>
              </div>
            </div>
