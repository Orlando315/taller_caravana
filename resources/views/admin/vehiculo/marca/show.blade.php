...
@section('content')
  <div class="row">
    <div class="col-12">
      ...
      <a class="btn btn-success" href="{{ route('admin.vehiculo.marca.edit', ['marca' => $marca->id]) }}"><i class="fa fa-pencil" aria-hidden="true"></i> Editar</a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="delModalLabel">Eliminar Marca</h4>
        ...
        <div class="modal-body">
          <div class="row justify-content-md-center">
            <form class="col-md-8" action="{{ route('admin.vehiculo.marca.destroy', ['marca' => $marca->id]) }}" method="POST">
              @csrf
              @method('DELETE')
