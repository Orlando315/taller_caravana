          ...
          <div class="card-body">
            <form action="{{ route('insumos.update', ['insumo' => $insumo->id]) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input id="minimo" class="form-control{{ $errors->has('minimo') ? ' is-invalid' : '' }}" type="number" name="minimo" min="1" max="9999999999" value="{{ old('minimo', $insumo->minimo) }}" placeholder="Stock mínimo" required>
              </div>
