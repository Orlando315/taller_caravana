              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select id="combustible" class="custom-select{{ $errors->has('combustible') ? ' is-invalid' : '' }}" name="combustible" required>
                    ...
                    <option value="Otro"{{ old('combustible', $inspeccion->combustible) == 'Otro' ? ' selected' : ''}}>Otro</option>
                  </select>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input id="otro" class="form-control{{ $errors->has('otro') ? ' is-invalid' : '' }}" type="number" step="0.01" min="0" max="999" name="otro" value="{{ old('otro', $inspeccion->otro) }}" placeholder="Especificar" disabled>
                </div>
              </div>
            </div>
